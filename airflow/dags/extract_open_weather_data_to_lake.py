...
def extract_open_weather_data_to_lake():
    ...
    def load(main_weather_content: dict):
        ...
        s3_hook.load_string(data,f'open_weather_map/bukit_lawang/{current_year}/{current_month}/{current_day}/main_weather_content.json',bucket_name='orangutan-orchard',replace=True)
